        ...
        return (
          <section className="crt_adm_stats_panel_758fde">
            <div className="crt_adm_stat_card_9a76bc">
              ...
              <p className="crt_adm_stat_value_482d1c">{stats ? stats.activeCases : '…'}</p>
            </div>
            <div className="crt_adm_stat_card_9a76bc">
              <h3 className="crt_adm_stat_heading_37c2ef">Today's Hearings</h3>
              <p className="crt_adm_stat_value_482d1c">{stats ? stats.todayHearings : '…'}</p>
            </div>
            <div className="crt_adm_stat_card_9a76bc">
              <h3 className="crt_adm_stat_heading_37c2ef">Pending Cases</h3>
              <p className="crt_adm_stat_value_482d1c">{stats ? stats.pendingCases : '…'}</p>
            </div>
            <div className="crt_adm_stat_card_9a76bc">
              <h3 className="crt_adm_stat_heading_37c2ef">Disposed Cases</h3>
              <p className="crt_adm_stat_value_482d1c">{stats ? stats.disposedCases : '…'}</p>
            </div>
            <div className="crt_adm_stat_card_9a76bc">
              <h3 className="crt_adm_stat_heading_37c2ef">Total Cases Filed</h3>
              <p className="crt_adm_stat_value_482d1c">{stats ? stats.totalCases : '…'}</p>
            </div>
            <div className="crt_adm_stat_card_9a76bc">
            ...
            <div className="crt_adm_stat_card_9a76bc">
              <h3 className="crt_adm_stat_heading_37c2ef">Total Litigants</h3>
              <p className="crt_adm_stat_value_482d1c">{stats ? stats.totalLitigants : '…'}</p>
            </div>
            <div className="crt_adm_stat_card_9a76bc">
              <h3 className="crt_adm_stat_heading_37c2ef">Total Advocates</h3>
              <p className="crt_adm_stat_value_482d1c">{stats ? stats.totalAdvocates : '…'}</p>
            </div>
          </section>
        );
      case 'verifications':
      ...
      <div className="crt_adm_main_content_wrapper_6c37d8">
        ...
        <aside className={`crt_adm_sidebar_panel_98e2d5 ${isSidebarOpen ? 'crt_adm_sidebar_active_state_f82d47' : ''}`}>
          <nav className="crt_adm_navigation_menu_5a9c63">
            ...
            <button
              className={`crt_adm_nav_menu_button_2d6f74 ${activeComponent === 'advocate-change' ? 'crt_adm_nav_active_state_e8d237' : ''}`}
              onClick={() => handleNavigation('advocate-change')}
            >
              <ShieldCheck className="crt_adm_nav_icon_display_7c8d33" />
              Advocate NOC Review
            </button>
          </nav>
        </aside>
