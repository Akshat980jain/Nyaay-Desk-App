...
const AdminMeetingPanel = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const endpoint = `https://nyaay-desk-app-backend.onrender.com/api/case/${selectedCase}/video-meeting`;
  ...
  const handleDeactivate = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://nyaay-desk-app-backend.onrender.com/api/case/${selectedCase}/video-meeting`,
