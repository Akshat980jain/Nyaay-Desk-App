  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Get holidays
        const holidaysResponse = await axios.get('https://nyaay-desk-app-backend.onrender.com/api/admin/calendar/holidays', {
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('token')}`
          }
        });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (entry) {
        ...
        response = await axios.put(`https://nyaay-desk-app-backend.onrender.com/api/calendar/${entry.calendar_id}`, data, {
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('token')}`
          }
        });
        ...
        // Create new entry
        response = await axios.post('https://nyaay-desk-app-backend.onrender.com/api/calendar', data, {
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('token')}`
          }
        });
