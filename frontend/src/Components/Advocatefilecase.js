          ...
          <div className="form-grid">
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) =>
                  handleNestedChange('plaintiff_details', 'occupation', e.target.value.replace(/[^a-zA-Z\s]/g, ''))
                }
                required
              />
            </div>
          ...
          <div className="form-grid">
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) =>
                  handleNestedChange('respondent_details', 'occupation', e.target.value.replace(/[^a-zA-Z\s]/g, ''))
                }
                required
              />
            </div>
